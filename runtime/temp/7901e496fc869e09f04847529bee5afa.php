<?php /*a:3:{s:88:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\spec_param\list.html";i:1563880535;s:86:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\common\header.html";i:1536755456;s:86:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\common\footer.html";i:1535296431;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="layui-inline" onclick="add('添加商品属性','<?php echo url('add',['group_id'=>isset($group_id)?$group_id:'']); ?>',true)">
                     ...
                     <table class="layui-table">
                        ...
                        <tbody class="news_content list-box-body">
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo htmlentities($data['segements']); ?></td>
                                <td align="center"><?php if($data['type'] == 1): ?>单选<?php else: ?>唯一<?php endif; ?></td>
                                <td align="center"><?php echo htmlentities($data['spec_group']['name']); ?></td>
                                <td align="center"><?php echo htmlentities($data['unit']); ?></td>
                                <td align="center"><?php echo !empty($data['is_add_img']) ? '是' : '否'; ?></td>
                                <td align="center"><?php echo !empty($data['searching']) ? '是' : '否'; ?></td>
                                <td align="center"><?php echo !empty($data['numeric']) ? '是' : '否'; ?></td>
                                <td align="center">
                                    <a class="layui-btn layui-btn-mini tb_edit" onclick="editFull('编辑分类','<?php echo url('edit',['id'=>$data['id'],'group_id'=>isset($group_id)?$group_id:'']); ?>')"><i class="fa fa-pencil fa-fw"></i> 编辑</a>
