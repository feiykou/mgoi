<?php /*a:3:{s:88:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\spec_group\list.html";i:1563873630;s:86:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\common\header.html";i:1536755456;s:86:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\common\footer.html";i:1535296431;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="layui-inline" onclick="add('添加商品类型','<?php echo url('add'); ?>',false,'600px','240px')">
                     ...
                     <table class="layui-table">
                        ...
                        <tbody class="news_content list-box-body">
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a class="layui-btn layui-btn-mini tb_edit" onclick="edit('商品属性','<?php echo url('spec_param/lst',['id'=>$data['id']]); ?>','900px','463px')"><i class="fa fa-id-card-o fa-fw"></i> 属性列表</a>
                                    <a class="layui-btn layui-btn-mini tb_edit" onclick="edit('编辑分类','<?php echo url('edit',['id'=>$data['id']]); ?>','600px','240px')"><i class="fa fa-pencil fa-fw"></i> 编辑</a>
