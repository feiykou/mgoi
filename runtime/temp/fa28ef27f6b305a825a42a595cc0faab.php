<?php /*a:3:{s:88:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\auth_group\list.html";i:1563247187;s:86:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\common\header.html";i:1536755456;s:86:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\common\footer.html";i:1535296431;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="layui-inline" onclick="add('添加用户组','<?php echo url('add'); ?>')">
			<a class="layui-btn layui-btn-normal newsAdd_btn">添加用户组</a>
		</div>
                ...
                <div class="layui-form news_list">
                    <table class="layui-table">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a class="layui-btn layui-btn-mini tb_edit" onclick="edit('编辑用户组','<?php echo url('edit',['id'=>$data['id']]); ?>','540px','380px')"><i class="fa fa-pencil fa-fw"></i> 编辑</a>
