<?php /*a:3:{s:82:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\theme\add.html";i:1564708136;s:86:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\common\header.html";i:1536755456;s:86:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\common\footer.html";i:1535296431;}*/ ?>
<!DOCTYPE html>
<html>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select name="" xm-select="product-sel">
                                    ...
                                    <option value="id:<?php echo htmlentities($data['id']); ?>;name:<?php echo htmlentities($data['name']); ?>;main_img_url:<?php echo htmlentities($data['main_img_url']); ?>;price:<?php echo htmlentities($data['price']); ?>"><?php echo htmlentities($data['name']); ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
