...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="layui-inline" onclick="add('添加规则','<?php echo url('add'); ?>')">
			<a class="layui-btn layui-btn-normal newsAdd_btn">添加规则</a>
		</div>
                ...
                <div class="layui-form news_list">
                    <table class="layui-table">
                        ...
                        <tr>
                            ...
                            <td align="center"><?php echo htmlentities($data['condition']); ?></td>
                            <td align="center">
                                <a class="layui-btn layui-btn-mini tb_edit" onclick="edit('编辑规则','<?php echo url('edit',['id'=>$data['id']]); ?>','540px','380px')"><i class="fa fa-pencil fa-fw"></i> 编辑</a>
