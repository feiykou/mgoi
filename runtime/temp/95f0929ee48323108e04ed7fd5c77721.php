<?php /*a:3:{s:84:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\product\add.html";i:1564675323;s:86:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\common\header.html";i:1536755456;s:86:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\common\footer.html";i:1535296431;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="layui-tab-content product-add-content">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <select xm-select="product-sel">
                                        ...
                                        <option value="id:<?php echo htmlentities($data['id']); ?>;name:<?php echo htmlentities($data['name']); ?>"><?php echo htmlentities($data['name']); ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-col-md2">
                            <input type="text" name="mp[<?php echo htmlentities($mlData['id']); ?>]" autocomplete="off" placeholder="级别价格" class="layui-input">
                        </div>
                    </div>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <select name="type_id" lay-filter="type_id">
                                ...
                                <option value="<?php echo htmlentities($resData['id']); ?>"><?php echo htmlentities($resData['name']); ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
            ...
            form.on('select(type_id)',function (data) {
                ...
                $.ajax({
                    ...
                    success:function(res){
                        var html = '';
                        if(!res.code){
                            layer.msg('获取失败', {icon: 5,time:1000,anim:0});
                            return;
                        }
