            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    <select name="group_id" lay-verify="required">
                        ...
                        <option value="<?php echo htmlentities($data['id']); ?>" <?php if($key == 0): ?>selected<?php endif; ?>><?php echo htmlentities($data['name']); ?></option>
