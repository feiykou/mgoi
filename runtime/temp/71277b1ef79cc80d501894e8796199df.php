<?php /*a:3:{s:84:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\recpos\list.html";i:1540268773;s:86:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\common\header.html";i:1536755456;s:86:"D:\SoftDownload\PHPTutorial\WWW\mgoi\mgoicms\application\admin\view\common\footer.html";i:1535296431;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                     ...
                     <table class="layui-table">
                        ...
                        <tbody class="news_content list-box-body">
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <?php if(is_array($rescBitArr) || $rescBitArr instanceof \think\Collection || $rescBitArr instanceof \think\Paginator): $i = 0; $__LIST__ = $rescBitArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rescData): $mod = ($i % 2 );++$i;if($data['type'] == $key): ?><?php echo htmlentities($rescData); ?><?php endif; ?>
